...
public class RestaurantServiceTest {
    ...
    public void shouldThrowAInvalidValueException() {
        assertThrows(InvalidValueException.class, () -> this.restaurantService.updateRestaurant(1, null));
    }

    @Test()
    public void shouldThrownAResourceDoesntExist() {
        when(restaurantRepository.findById(any())).thenReturn(Optional.empty());
        assertThrows(ResourceDoesntExistException.class, () -> this.restaurantService.updateRestaurant(1, "nouveau nom"));
    }
